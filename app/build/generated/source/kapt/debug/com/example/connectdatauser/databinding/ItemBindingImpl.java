...
public class ItemBindingImpl extends ItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_item_id, 1);
        sViewsWithIds.put(R.id.text_item_login, 2);
        sViewsWithIds.put(R.id.text_item_type, 3);
        sViewsWithIds.put(R.id.text_item_url, 4);
    }
    // views
    @NonNull
