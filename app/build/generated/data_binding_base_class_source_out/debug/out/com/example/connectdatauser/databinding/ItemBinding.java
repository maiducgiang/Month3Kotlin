...
public abstract class ItemBinding extends ViewDataBinding {
  @NonNull
  public final TextView textItemId;

  @NonNull
  public final TextView textItemLogin;

  @NonNull
  public final TextView textItemType;

  @NonNull
  public final TextView textItemUrl;

  protected ItemBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TextView textItemId, TextView textItemLogin, TextView textItemType, TextView textItemUrl) {
    super(_bindingComponent, _root, _localFieldCount);
    this.textItemId = textItemId;
    this.textItemLogin = textItemLogin;
